...
/**
 * Renders a premium gradient placeholder by default. If a car has a valid
 * imageUrl, it is shown on top. Any load error silently falls back to the
 * placeholder so a broken image never appears.
 */
export default function CarImage({
  ...
  const showImage = Boolean(car.imageUrl && car.imageUrl.trim() !== "" && !failed);
      ...
      {!showImage && (
        <>
          ...
          >
            ...
            <path
              d="M-20 210 Q160 150 440 215"
              stroke={`url(#g-${hue})`}
              strokeWidth="2"
              fill="none"
            />
            <path
              d="M-20 235 Q200 175 460 235"
              stroke="#ffffff"
              strokeOpacity="0.15"
              strokeWidth="1"
              fill="none"
          ...
          >
            ...
            <path
              d="M58 36c2-3 6-5 11-5h30c10 0 18 3 26 9l6 5H64l-6-9z"
              fill="#0b1220"
              fillOpacity="0.25"
            />
          </svg>
