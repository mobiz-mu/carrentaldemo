...
export default function WhatsAppButton({
  ...
  const variants: Record<string, string> = {
    solid: "bg-[#25D366] text-white hover:bg-[#1da851] shadow-sm",
    outline:
      "border border-[#25D366] text-[#1da851] hover:bg-[#25D366]/10 bg-white",
  ...
  return (
    <button
      ...
      aria-label={ariaLabel ?? (typeof children === "string" ? children : "Book on WhatsApp")}
